...
export const ACADS_LINES = [
  ...
  "  ",
  "Tip: Try `interests` to continue my story beyond acads and work.",
  "[Last updated: September 19, 2025]",
];
